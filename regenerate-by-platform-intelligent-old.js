...
const MIN_WORD_COUNT = 3200; // Increased from 2500 for higher quality
...
## YOUR TASK:
Read the specification YAML and generate comprehensive requirements.

## FILES TO READ:
- /ai-generated/specification.yaml (required)
- /ai-generated/market-enhanced-spec.yaml (if exists)

## FILE TO CREATE:
- /ai-generated/requirements.md

Create a comprehensive requirements document (minimum 3500 words) based on the specification.
Output the file directly to /ai-generated/requirements.md using MCP.Filesystem tool.

Start reading specification.yaml now.`;
